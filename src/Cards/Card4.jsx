    ...
    <div className='m-8'>
        <div className='bg-orange-400 w-96 rounded-xl flex'>
            ...
            <div className='p-4 w-48'>
                ...
                <span className='text-sm text-orange-900'>Cada vez que se hace referencia al jugo de naranja no podemos dejar de imaginar un delicioso desayuno para empezar el día con toda la energía posible. </span>
