    ...
    <div className="m-8">
      <div className="bg-slate-300 w-60 h-80 rounded-xl">
        <div className="w-full p-2 relative">
          ...
          <span className="absolute top-1 right-1 mt-6 mr-8 bg-green-600 rounded-xl p-1 text-sm text-white">On</span>
        </div>
        ...
        <div className="flex">
          <button className="w-1/2 p-2 rounded-xl text-white font-bold mx-auto mt-8 bg-blue-400">Seguir</button>
        </div>
      </div>
    </div>
  );
